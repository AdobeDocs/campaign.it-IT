...
[Ulteriori informazioni](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"} sui metodi SOAP statici e non statici.
...
Utilizzare il metodo `DeleteCollection`. [Ulteriori informazioni](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
...
Il ciclo include una variabile di destinatario locale. Per ogni destinatario restituito nella raccolta di destinatari, viene stampata l’e-mail del destinatario. [Ulteriori informazioni](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"} sulla funzione `logInfo`.
...
* Per pubblicare un evento, è possibile utilizzare il metodo statico `PostEvent`. [Ulteriori informazioni](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
...
1. Definisci la query:
   ...
   * Recuperare un&#39;entità utilizzando il metodo `create` nello schema corrispondente, ad esempio lo schema `xtk:workflow`. [Ulteriori informazioni](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
   * Utilizzare il metodo `queryDef` per eseguire una query SQL.

1. Eseguire la query utilizzando il metodo `ExecuteQuery`. [Ulteriori informazioni](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
...
* [Esempi di chiamate SOAP](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}
* Metodi:
  * [Crea](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}
  * [DeleteCollection](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}
  * [ExecuteQuery](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}
  * [PostEvent](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}
  * [Scrittura](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}
* [funzione logInfo](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}
