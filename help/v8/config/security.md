...
description: Linee guida per la configurazione sicura consigliate per Campaign
feature: Privacy, PI
role: Developer
level: Beginner
...
### Dove trovare questa guida {#public-guidance}

Adobe Campaign al momento non fornisce le istruzioni di configurazione sicure consigliate in un formato leggibile al computer. Per confrontare le impostazioni correnti con i valori predefiniti di protezione consigliati, è possibile utilizzare la seguente documentazione:

* **Questa pagina** - [Best practice per la sicurezza di Campaign](#ac-security) (elenco di controllo e sezioni dettagliate)
* **[Impostazioni campagna (FAQ)](../start/campaign-faq-comprehensive.md#settings)** - Confronta le impostazioni con le impostazioni sicure consigliate
* **[Componente aggiuntivo di sicurezza avanzato](enhanced-security.md)** - Integrazione CMK sicura e tunneling VPN sicuro
* **[Introduzione alle autorizzazioni](../start/gs-permissions.md)** - Profili di accesso e di prodotto
* **[Limita visualizzazione PII](../dev/restrict-pi-view.md)** - Limitazione dell&#39;accesso ai campi sensibili
* **[Linee guida per l&#39;implementazione](../start/implement.md)** - Sicurezza e privacy prima di iniziare
