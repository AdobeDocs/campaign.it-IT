---
title: Invia con l’MTA avanzato in Adobe Campaign
...
# Inviare con MTA avanzato {#sending-with-enhanced-mta}
...
* Utilizza la più recente tecnologia MTA per fornire le velocità di throughput ottimali per la consegna delle e-mail.
