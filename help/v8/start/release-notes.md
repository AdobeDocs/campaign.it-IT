...
* Il file setup-client.exe è stato sostituito da un file ac-client.msi. Questo offre agli amministratori un modo più semplice di eseguire aggiornamenti di massa senza l’intervento dell’utente.
