...
Oltre alle funzioni elencate in precedenza, questa versione include anche una serie di funzionalità disponibili con l’interfaccia utente di Campaign Web:
...
* [Branding centralizzato](https://experienceleague.adobe.com/docs/campaign-web/v8/conf/branding/branding-gs.html){target="_blank"}
...
* Una versione rinnovata del rapporto di rendering della casella in entrata è ora disponibile nella console client di Adobe Campaign. [Ulteriori informazioni](../send/inbox-rendering.md)
...
* Meccanismo di installazione automatica della console client per facilitare gli aggiornamenti di massa senza l&#39;intervento dell&#39;utente. In questo modo è possibile risolvere i problemi relativi alle installazioni manuali. (NEO-69772)
