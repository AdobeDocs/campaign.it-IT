...
1. Fai clic sul pulsante **[!UICONTROL Add]** per definire i filtri di restrizione.
   ...
   * **[!UICONTROL Filtering conditions]**: utilizza questa opzione per definire una query e visualizzare il risultato. Per informazioni su come progettare una query, consulta [questa sezione](../../automation/workflow/query.md).
