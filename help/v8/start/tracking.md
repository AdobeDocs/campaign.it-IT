...
Ulteriori informazioni sulle informazioni che è possibile monitorare dopo l&#39;invio di una consegna e sulla gestione degli errori di consegna e della quarantena nella [documentazione di Campaign Classic v7](https://experienceleague.adobe.com/docs/campaign-classic/using/sending-messages/monitoring-deliveries/about-delivery-monitoring.html?lang=it#sending-messages){target="_blank"}
