...
[Documentazione del Pannello di controllo Campaign](https://experienceleague.adobe.com/it/docs/control-panel/using/control-panel-home){target="_blank"} | [Video tutorial di Pannelli di controllo Campaign](https://experienceleague.adobe.com/en/docs/control-panel-learn/tutorials/control-panel-overview){target="_blank"}
...
**Accesso:** [Documentazione API di Campaign v8](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}
...
* **[API di Campaign](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"}** - Documentazione completa di riferimento API
