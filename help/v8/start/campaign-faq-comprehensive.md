...
[Creare pagine di destinazione (interfaccia Web)](https://experienceleague.adobe.com/en/docs/campaign-web/v8/landing-pages/get-started-lp){target="_blank"} | [Applicazioni Web (console client)](../dev/landing-pages.md)
