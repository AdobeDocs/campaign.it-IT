...
[Descrizione del prodotto Campaign v8](https://helpx.adobe.com/it/legal/product-descriptions/adobe-campaign-managed-cloud-services.html){target="_blank"} | [Novità della versione v8](whats-new.md) | [Guida introduttiva](get-started.md)
...
[Introduzione alle autorizzazioni](gs-permissions.md) | [Gestione delle autorizzazioni utente](manage-permissions.md) | [Aggiunta delle autorizzazioni alle cartelle](folder-permissions.md)
...
[Definire i tipi di pubblico in Campaign v8](../audiences/gs-audiences.md) | [Editor query](query-editor.md) | [Mappature target](../audiences/target-mappings.md)
...
In alternativa, partecipa a [Community Campaign](https://experienceleaguecommunities.adobe.com/t5/adobe-campaign-classic/ct-p/adobe-campaign-classic-community?profile.language=it){target="_blank"} per cercare risposte o chiedere agli esperti.
...
* **Community di Campaign** - Partecipa a [discussioni](https://experienceleaguecommunities.adobe.com/t5/adobe-campaign-classic/ct-p/adobe-campaign-classic-community?profile.language=it){target="_blank"} per aggiornamenti anticipati
...
[Funzionalità chiave di Campaign v8](whats-new.md) | [Architettura di Campaign v8](../architecture/architecture.md) | [Matrice di capacità](https://experienceleague.adobe.com/it/docs/campaign-web/v8/start/capability-matrix){target="_blank"} | [Guardrail e limitazioni](ac-guardrails.md)

+++

+++ Devo effettuare la migrazione da Campaign Classic v7 o Campaign Standard a v8?

Campaign v8 è la piattaforma di Adobe, ideale per le organizzazioni che necessitano di campagne dal volume elevato (20 milioni di operazioni all’ora), di una moderna interfaccia utente web, di vantaggi nativi per il cloud e di supporto a lungo termine.
...
[Da Campaign Classic v7 a v8](v7-to-v8.md) | [Guida alla transizione di Campaign Standard](https://experienceleague.adobe.com/it/docs/campaign-web/v8/start/acs-migration){target="_blank"} | [Matrice di capacità](https://experienceleague.adobe.com/it/docs/campaign-web/v8/start/capability-matrix){target="_blank"}
...
Ulteriori informazioni sulla [migrazione a Managed Services](https://experienceleaguecommunities.adobe.com/t5/adobe-campaign-classic-blogs/migrate-your-adobe-campaign-v7-onprem-hybrid-environment-to/ba-p/681605?profile.language=it){target="_blank"}, incluse le sfide, le best practice e la roadmap dettagliata per la migrazione.
...
* Risorse personalizzate → **Schemi** | Messaggi → **Consegne** | Utenti prodotto → **Operatori**
...
* Destinatari → **Profili** | Indirizzi di seed → **Profili di test** | Analisi della consegna → **Preparazione della consegna**
...
[Matrice di funzionalità](https://experienceleague.adobe.com/it/docs/campaign-web/v8/start/capability-matrix){target="_blank"} | Guida alla transizione da [v7 a v8](v7-to-v8.md) | [Transizione da Campaign Standard a v8](https://experienceleague.adobe.com/it/docs/campaign-web/v8/start/acs-migration){target="_blank"}
...
[Creare profili manualmente](../audiences/create-profiles.md) | [Importare profili da un file](../audiences/import-profiles.md) | [Raccogliere profili con moduli Web](../audiences/collect-profiles.md)
...
[Crea tipi di pubblico](../audiences/create-audiences.md) | [Attività di aggiornamento elenco](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/list-update.html?lang=it){target="_blank"}
...
[Introduzione al recapito messaggi](../send/about-deliverability.md) | [Contenuto dei messaggi di controllo](../send/control-message-content.md) | [Monitoraggio del recapito messaggi](../send/monitoring-deliverability.md) | [SpamAssassin](../send/spamassassin.md)
...
[Tracciare e monitorare le consegne](../send/tracking.md) | [Best practice per le consegne](delivery-best-practices.md)
...
Ulteriori informazioni sono disponibili nella [Guida agli indirizzi seed](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/action-activities/delivery-control.html?lang=it){target="_blank"}
...
[Convalida consegna](../send/preview-and-proof.md) | [Approvazioni campagna](https://experienceleague.adobe.com/docs/campaign/automation/campaign-orchestration/marketing-campaign-approval.html?lang=it){target="_blank"}
...
[Monitoraggio della consegna](../send/send.md) | [Guida al monitoraggio](../send/tracking.md)
...
[Rapporti di consegna incorporati](../reporting/delivery-reports.md) | [Rapporti sulle campagne](../reporting/gs-reporting.md)
...
[Guida alla gestione della quarantena](../send/quarantines.md) | [Gestione delle e-mail non consegnate](../send/delivery-failures.md)
...
[Introduzione ai flussi di lavoro](../config/workflows.md) | [Crea il tuo primo flusso di lavoro](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/build-a-workflow.html?lang=it){target="_blank"} | [Casi d&#39;uso del flusso di lavoro](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/about-workflow-use-cases.html){target="_blank"} | [Controlla l&#39;esecuzione del flusso di lavoro](https://experienceleague.adobe.com/docs/campaign/automation/workflows/monitoring-workflows/monitor-workflow-execution.html?lang=it){target="_blank"}
...
[Libreria casi d&#39;uso per flussi di lavoro](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/about-workflow-use-cases.html){target="_blank"} | [Crea un flusso di lavoro](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/build-a-workflow.html?lang=it){target="_blank"} | [Best practice per flussi di lavoro](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/workflow-best-practices.html?lang=it){target="_blank"}
...
[Attività divisa](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/split.html?lang=it){target="_blank"} | [Guida test A/B](https://experienceleague.adobe.com/docs/campaign/automation/workflows/use-cases/deliveries/a-b-testing.html){target="_blank"}
...
[Guida alle best practice per i flussi di lavoro](https://experienceleague.adobe.com/docs/campaign/automation/workflows/introduction/workflow-best-practices.html?lang=it){target="_blank"} | [Monitorare i flussi di lavoro](https://experienceleague.adobe.com/docs/campaign/automation/workflows/monitoring-workflows/monitor-workflow-execution.html?lang=it){target="_blank"}
...
[Cambia lingua nell&#39;interfaccia utente di Campaign Web](https://experienceleague.adobe.com/it/docs/campaign-web/v8/start/connect-to-campaign#language-pref){target="_blank"} | [Introduzione alla console del client di Campaign](connect.md)
...
[Documentazione del Pannello di controllo Campaign](https://experienceleague.adobe.com/it/docs/control-panel/using/control-panel-home){target="_blank"} | [Video tutorial del Pannello di controllo Campaign](https://experienceleague.adobe.com/it/docs/control-panel-learn/tutorials/control-panel-overview){target="_blank"}

+++

+++ Come posso verificare che i miei operatori e le mie autorizzazioni seguano le best practice per la sicurezza?
...
[Introduzione alle autorizzazioni](gs-permissions.md) | [Linee guida sulla sicurezza](../config/security.md) | [Componente aggiuntivo per la sicurezza avanzata](../config/enhanced-security.md)
...
[Tracciare e monitorare le consegne](../send/tracking.md) | [Configurare i collegamenti tracciati](../send/tracked-links.md) | [Tracciare i test](../send/testing-tracking.md)
...
[Informazioni sul recapito messaggi in Campaign](../send/about-deliverability.md) | [Guida alle best practice per il recapito messaggi](https://experienceleague.adobe.com/docs/deliverability-learn/deliverability-best-practice-guide/introduction.html?lang=it){target="_blank"}

+++

+++ Come posso accedere ai dati memorizzati in un database esterno?

Campaign v8 fornisce Federated Data Access (FDA) per eseguire query e utilizzare i dati memorizzati in database esterni senza modificare il modello dati di Campaign. Puoi configurare un account esterno, quindi utilizzare FDA in flussi di lavoro, query e targeting per combinare dati esterni con i profili di Campaign.

La disponibilità FDA e i requisiti di connessione dipendono dall’implementazione e dalle licenze. Verificare i database supportati e le versioni richieste nella matrice di compatibilità.

**Argomenti correlati:**

[Configura connessioni FDA](../connect/fda.md) | [Matrice di compatibilità](compatibility-matrix.md)
...
[Configurazione connettore CRM](../connect/crm.md) | [Attività CRM flusso di lavoro](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/crm-connector.html?lang=it){target="_blank"}
...
**Se il problema persiste (modalità avanzata):**

Chiudi la console client, quindi rimuovi manualmente i file della cache locale dal profilo utente.

**Pulizia manuale della cache (Windows):**

1. Nella console del client, selezionare **[!UICONTROL File]** > **[!UICONTROL Clear the local cache...]**.
2. Esci e chiudi la console client.
3. Passa alla posizione della cache in base alla versione di Windows in uso. Per Windows 10: `C:\Users\<Username>\AppData\Roaming\Neolane\NL_5\`
4. Eliminare i file `nlclient-config-<alphanumerical>.xml` e le relative cartelle associate.

>[!IMPORTANT]
>
>Non eliminare `nlclient_cnx.xml`.

Il supporto Adobe può confermare la posizione corretta della cache per la versione e il sistema operativo in uso e guidarti attraverso una pulizia manuale sicura.

Ulteriori informazioni in [Installare e configurare la console client](connect.md)

+++

+++ Adobe Campaign può integrarsi con il protocollo LDAP?

No. Campaign v8 non supporta l’integrazione LDAP. L’autenticazione utilizza Adobe IMS (Adobe ID o Federated ID). Se stai eseguendo la migrazione da Campaign Classic v7, controlla le funzioni non supportate e le modifiche di autenticazione.

**Argomenti correlati:**

[Connetti a Campaign v8](connect.md) | [Funzioni non supportate in v8](v7-to-v8.md#gs-removed)
...
[Estendi modello dati](../dev/extend-schema.md) | [Struttura schema](../dev/schemas.md) | [Best practice modello dati](../dev/datamodel-best-practices.md)
...
[Introduzione alla generazione di rapporti](../reporting/gs-reporting.md) | [Rapporti sull&#39;interfaccia utente web di Campaign](https://experienceleague.adobe.com/en/docs/campaign-web/v8/reports/gs-reports){target="_blank"}
...
[Introduzione ai sondaggi](https://experienceleague.adobe.com/it/docs/campaign-classic/using/online-surveys/about-surveys){target="_blank"} | [Rapporti sui sondaggi](https://experienceleague.adobe.com/it/docs/campaign-classic/using/online-surveys/publish-track-and-use-collected-data#reports-on-surveys){target="_blank"}
...
[Rapporti personalizzati](../reporting/custom-reports.md) | [Rapporti interfaccia utente Web Campaign](https://experienceleague.adobe.com/en/docs/campaign-web/v8/reports/gs-reports){target="_blank"}
...
[Modello dati campagna](../dev/datamodel.md) | [Best practice modello dati](../dev/datamodel-best-practices.md)
...
[Tabella destinatari personalizzata](../dev/custom-recipient.md) | [Mappature destinazione](../audiences/target-mappings.md)
...
[Editor query](../start/query-editor.md) | [Attività query](https://experienceleague.adobe.com/docs/campaign/automation/workflows/wf-activities/targeting-activities/query.html?lang=it){target="_blank"}
...
[Gestione della privacy](../start/privacy.md) | [Importa flussi di lavoro](../config/workflows.md)
...
[Gestione della privacy](../start/privacy.md) | [Iscrizioni](../start/subscriptions.md)
...
* **[Community di Adobe Campaign](https://experienceleaguecommunities.adobe.com/t5/adobe-campaign-classic/ct-p/adobe-campaign-classic-community?profile.language=it){target="_blank"}** - Poni domande, condividi soluzioni e collegati alla community di Campaign
* **[Forum Experience League](https://experienceleaguecommunities.adobe.com/?profile.language=it){target="_blank"}** - Sfogliare discussioni tra tutti i prodotti Adobe
