...
1. **Come posso aggiornare Campaign alla versione più recente?**
   ...
   >[!NOTE]
   >
   >In qualità di utente di Managed Cloud Service, l’istanza viene aggiornata da Adobe con ogni nuova versione.
...
1. **Qual è la procedura per la delega del dominio?**
   ...
   >[!NOTE]
   >
   >In qualità di utente di Cloud Service gestiti, contatta l’Adobe per delegare i sottodomini ad Adobe.
...
1. **Come utente Campaign Classic v7, posso effettuare la migrazione a Campaign v8?**
   ...
   Per ulteriori informazioni sul processo di migrazione, contatta il rappresentante del tuo Adobe.
