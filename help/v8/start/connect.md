...
A partire dalla versione della build di Campaign Classic 8.4, è necessaria l’installazione di Microsoft Edge Webview 2 Runtime per qualsiasi installazione della console client.
...
1. In qualità di amministratore di Campaign, connettiti ad Adobe [Distribuzione software](https://experience.adobe.com/#/downloads/content/software-distribution/it/campaign.html){target="_blank"}.
...
Alcune parti dell’applicazione sono accessibili tramite un browser web che utilizza un’interfaccia utente di HTML: reporting, approvazione della consegna, monitoraggio delle istanze e altro ancora.
