...
+ Note sulle versioni {#releases}
   ...
   + [Ultima versione](start/release-notes.md)
   + Note sulla versione precedente {#previous-rn}
      + [Versioni 2023](start/release-notes-2023.md)
      + [Versioni 2022](start/release-notes-2022.md)
      + [Versioni 2021](start/release-notes-2021.md)
...
+ Inviare messaggi{#send}
   ...
   + Notifiche push {#push}
      ...
      + [Progettare una consegna push Android avanzata](send/rich-push.md)
...
+ [Pannello di controllo Campaign >](https://experienceleague.adobe.com/en/docs/control-panel/using/control-panel-home)
+ [Guida all’automazione di Campaign >](https://experienceleague.adobe.com/en/docs/campaign/automation/home)
+ [Documentazione sull’interfaccia web di Campaign >](https://experienceleague.adobe.com/it/docs/campaign-web/v8/campaign-web-home)
