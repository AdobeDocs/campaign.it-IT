...
:lampadina: Per ulteriori informazioni, consulta [Estendere uno schema](extend-schema.md).
...
:lampadina: Ulteriori informazioni sulle chiavi in [questa sezione](database-mapping.md#management-of-keys).
