...
Puoi utilizzare [le API di Campaign JavaScript](https://experienceleague.adobe.com/en/tools/campaign-api){target="_blank"} per scrivere nel database cloud di Campaign o leggere dal database:
