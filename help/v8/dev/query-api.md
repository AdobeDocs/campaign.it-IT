...
In base alla [documentazione JSAPI per Campaign](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}, &quot;gli schemi sono oggetti globali &#39;NLWS&#39;.&quot; La sintassi per accedere ai metodi dello schema segue il seguente schema:
...
* `load(id)` - Carica un&#39;entità in base al relativo ID. [Ulteriori informazioni](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}
...
Per utilizzare metodi di SOAP non statici, è innanzitutto necessario recuperare un&#39;entità utilizzando i metodi `load` o `create` negli schemi corrispondenti. Ulteriori informazioni sono disponibili nella [documentazione JSAPI per Campaign](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
...
Ulteriori informazioni sui metodi queryDef sono disponibili nella [documentazione JSAPI di Campaign](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
...
Ulteriori informazioni su [ExecuteQuery](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"} e [best practice per le query](https://opensource.adobe.com/acc-js-sdk/xtkQueryDef.html){target="_blank"}.
...
>[!CAUTION]
>
>Utilizzare sempre query con parametri con `$(sz)` per le stringhe e `$(l)` per i numeri interi per evitare vulnerabilità SQL injection. Ulteriori informazioni sono disponibili nella [documentazione JSAPI per Campaign](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
...
Ulteriori informazioni su [BuildQuery](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
...
Ulteriori informazioni su [BuildQueryEx](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
...
Ulteriori informazioni su [SelectAll](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
...
Ulteriori informazioni sull&#39;[aggiornamento](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
...
Ulteriori informazioni su [GetInstanceFromModel](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}.
...
* [Riferimento API per queryDef](https://experienceleague.adobe.com/it/tools/campaign-api){target="_blank"}
